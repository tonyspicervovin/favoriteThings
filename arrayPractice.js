...
let hundredAUD = 100 * rates.AUD;
console.log(hundredAUD)
var highest = 0
for (var rate in rates){
    if (rates[rate] > highest){
        highest = rates[rate]
    }
}
console.log(highest)
...
console.log("Gary's cats name is "+cats_and_owners[1].cat)
cats_and_owners.push({name: 'Taylor Swift', cat: 'Meredith'})
cats_and_owners.forEach(function(object,i){
    console.log(object.name+"'s cat's name is "+object.cat)
    })
...
for(var att in nobel_prize_winners_2017.prizes[0].laureates){
    console.log(nobel_prize_winners_2017.prizes[0].laureates[att].id)
}
for (var cat in nobel_prize_winners_2017.prizes){
    for (x in cat){
        console.log(nobel_prize_winners_2017.prizes[cat].category)
    }
}
let count = 0;
for (var cat in nobel_prize_winners_2017.prizes){
...
console.log("There are "+count+" catagories")